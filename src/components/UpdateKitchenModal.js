...
function UpdateKitchenModal({ id }) {
  const {
    single_kitchen: {
      kitchenId = '',
      // price = '',
  ...
  const handleSubmit = async () => {
    ...
    const responseCreate = await updateKitchen(id, kitchen);
    setLoading(false);
  ...
  return (
    <>
      ...
      <Modal initialFocusRef={initialRef} isOpen={isOpen} onClose={onClose}>
        <ModalOverlay />
        <ModalContent>
          <ModalHeader>Create new kitchen</ModalHeader>
          <ModalCloseButton />
          <ModalBody pb={6}>
            <FormControl>
              ...
              <Input
                ...
                value={kitchenId}
                onChange={updateExistingKitchenDetails}
              />
            </FormControl>
            ...
            <FormControl mt={4}>
              ...
              <Input
                placeholder='Kitchen Sizes (comma separated)'
                name='sizes'
                focusBorderColor='brown.500'
                value={sizes}
                onChange={updateExistingKitchenDetails}
            ...
            <FormControl mt={4}>
              ...
              <Input
                placeholder='Kitchen Colors (comma separated)'
                name='colors'
                focusBorderColor='brown.500'
                value={colors}
                onChange={updateExistingKitchenDetails}
...
export default UpdateKitchenModal;
