...
function CreateNewKitchenModal() {
  const {
    new_kitchen: {
      kitchenId,
      // price,
  ...
  const handleSubmit = async () => {
    ...
    const responseCreate = await createNewKitchen(kitchen);
    setLoading(false);
          ...
          <ModalBody pb={6}>
            <FormControl>
              ...
              <Input
                ...
                value={kitchenId}
                onChange={updateNewKitchenDetails}
              />
            </FormControl>
...
export default CreateNewKitchenModal;
